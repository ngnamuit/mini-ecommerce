...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2015 at 06:17 AM
...
INSERT INTO `apartment` (`id`, `name_en`, `name_ja`, `name_cn`, `name_vi`, `sort`, `content_vi`, `content_en`, `content_ja`, `content_cn`) VALUES
(1, 'Binh duong Province', 'Bình Dương', 'Bình Dương', 'Bình Dương', 0, 'Address:<br />\r\nPhone:', 'address:', 'address:', 'address:'),
(2, 'Viet Australia Auditing Ltd ', 'ベトナムの監査会社 - USTRALIA', 'ベトナムの監査会社 - US china', 'Kiểm toán Việt Úc', 1, '18B Nam Quốc Cang, Quận 1,TP.HCM, Việt Nam', '18B Nam Quoc Cang, District 1, HCMC, Vietnam', '18Bナムコック倉、1区、ホーチミン市、ベトナム', '18B南富国苍，1区，胡志明市，越南');
...
INSERT INTO `category` (`id`, `name_vi`, `name_en`, `name_ja`, `name_cn`, `target`, `updated`, `parent_id`, `keywords`, `status`, `sort`, `f_post`) VALUES
(1, 'Giới thiệu', 'Giới thiệu', 'Giới thiệu', '', 'gioi-thieu', '2015-10-07 07:00:00', 0, 'giới thiệu', 1, 1, 1),
(2, 'Dịch vụ', '', 'Dịch vụ', 'Dịch vụ', 'dich-vu', '2015-10-07 07:07:59', 0, 'dịch vụ', 1, 2, 1),
(3, 'Khách hàng', '', '', '', 'khach-hang', '2015-10-07 07:19:07', 0, 'khách hàng', 1, 3, 0),
(4, 'Tin tức & Sự kiện', '', '', '', 'tin-tuc-su-kien', '2015-10-07 07:20:43', 0, 'Tin tức & Sự kiện', 1, 4, 0),
(5, 'Tài liệu', '', '', '', 'tai-lieu', '2015-10-07 07:21:02', 0, 'Tài liệu', 1, 5, 0),
(6, 'Tuyển dụng', '', '', '', 'tuyen-dung', '2015-10-07 07:24:14', 0, 'Tuyển dụng', 1, 6, 0),
(7, 'Khách hàng tiêu biểu', '', '', '', 'khach-hang-tieu-bieu', '2015-10-07 07:32:22', 3, 'khách hàng tiêu biểu', 1, 1, 1),
(8, 'Dự án tiêu biểu', '', '', '', 'du-an-tieu-bieu', '2015-10-07 07:32:52', 3, 'Dự án tiêu biểu', 1, 2, 1),
(9, 'Tuyển nhân sự', '', '', '', 'tuyen-nhan-su', '2015-10-07 07:45:06', 6, 'tuyển nhân sự', 1, 1, 1),
(10, 'Tuyển thực tập', '', '', '', 'tuyen-thuc-tap', '2015-10-07 07:47:26', 6, 'Tuyển thực tập', 1, 2, 1),
(11, 'Tuyển dụng cho khách hàng', '', '', '', 'tuyen-dung-cho-khach-hang', '2015-10-07 07:47:56', 6, 'Tuyển dụng cho khách hàng', 1, 3, 1),
(13, 'Tài liệu về kế toán', 'Document Accounting', 'タイルドンナイ', '文档会计', 'tai-lieu-ve-ke-toan', '2015-10-13 16:00:19', 5, 'kế toán', 1, 1, 1),
(14, 'Tài liệu công ty', 'Tài liệu công ty', 'Tài liệu công ty', 'Tài liệu công ty', 'tai-lieu-cong-ty', '2015-10-14 02:47:35', 5, 'Tài liệu công ty', 1, 2, 1);
...
INSERT INTO `post` (`id`, `updated`, `category`, `keywords`, `alias`, `status`, `sort`, `images`, `user`, `title_vi`, `title_en`, `title_ja`, `title_cn`, `content_vi`, `content_en`, `content_ja`, `content_cn`, `description_vi`, `description_en`, `description_ja`, `description_cn`, `viewed`, `slider`) VALUES
(3, '2015-10-08 10:14:16', 8, '', 'b', 1, 2, '/uploads/adv/2.jpg', 0, 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 0, 0),
(5, '2015-10-12 16:42:48', 2, '', '.html', 1, 1, '/uploads/1440833708-1440576882-iphone-6s.jpg', 1, 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', '<span style="color:rgb(34, 34, 34); font-family:dejavu sans mono,monospace; font-size:11px">Kiểm to&aacute;n b&aacute;o c&aacute;o t&agrave;i ch&iacute;nh</span>', '<span style="color:rgb(34, 34, 34); font-family:dejavu sans mono,monospace; font-size:11px">Kiểm to&aacute;n b&aacute;o c&aacute;o t&agrave;i ch&iacute;nh</span>', '<span style="color:rgb(34, 34, 34); font-family:dejavu sans mono,monospace; font-size:11px">Kiểm to&aacute;n b&aacute;o c&aacute;o t&agrave;i ch&iacute;nh</span>', '<span style="color:rgb(34, 34, 34); font-family:dejavu sans mono,monospace; font-size:11px">Kiểm to&aacute;n b&aacute;o c&aacute;o t&agrave;i ch&iacute;nh</span>', 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', 'Kiểm toán báo cáo tài chính', 0, 0),
(6, '2015-10-13 16:01:21', 13, '', '.html', 1, 1, '/uploads/%5BIntern%20Digital%5D%20Create-account-Blog-PND.xlsx', 1, 'test kế toán', 'test kế toán', 'test kế toán', 'test kế toán', 'test kế to&aacute;n', 'test kế to&aacute;n', 'test kế to&aacute;n', 'test kế to&aacute;n', 'test kế toán', 'test kế toán', 'test kế toán', 'test kế toán', 0, 1),
(8, '2015-10-14 04:13:28', 13, '', '', 0, 1, '/uploads/%5BIntern%20Digital%5D%20Create-account-Blog-PND.xlsx', 0, 'test', 'test', 'test', 'test', '', '', '', '', '', '', '', '', 0, 0),
(9, '2015-10-14 04:13:54', 13, '', '', 0, 1, '/uploads/%5BIntern%20Digital%5D%20Create-account-Blog-PND.xlsx', 0, 'test', 'test', 'test', 'test', '', '', '', '', '', '', '', '', 0, 0);
...
INSERT INTO `quick_links` (`id`, `name_vi`, `name_en`, `name_ja`, `name_cn`, `link`, `sort`, `status`) VALUES
(1, 'Bộ tài chính', 'Ministry of Finance', 'MOF', '财政部', 'https://translate.google.com/', 0, 1),
(2, 'Hệ thống khai thuế', 'Tax system', '税制', '税收制度', 'https://translate.google.com', 0, 1);
...
INSERT INTO `setting` (`id`, `page_name`, `keywords`, `description`) VALUES
(1, 'Công ty Kiểm Toán Việt Úc  ', 'vietaustralia, viet australia, Auditing, kiem toan, ke toan, dich vu, nhan su, tai chinh, vietnam, asiviportal, infotechvn, Audit, accounting', 'Công ty Ki?m Toán Vi?t Úc là t? ch?c ki?m toán ??c l?p ???c c?p gi?y phép và thành l?p t?i n??c C?ng Hoà Xã H?i Ch? Ngh?a Vi?t Nam');
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `permittion`, `status`, `fullname`) VALUES
(1, 'admin', '6512bd43d9caa6e02c990b0a82652dca', 'admin@test.com', 'admin', 1, 'phuong nam web');
