...
class PaymentController {
	...
	// Mã merchante site 
	private $merchant_id = '6720b0322820232c';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	...
	public function createRequestUrlAction($order_id='', $business='', $total_amount='', $shipping_fee='', $tax_fee='', $order_description='', $url_success='', $url_cancel='', $url_detail='')
	{
	 ...
	 */
	// public function verifyResponseUrlAction($_GET = array())
	// {
